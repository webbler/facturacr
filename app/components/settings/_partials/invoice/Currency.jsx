      ...
      <Row>
        ...
        <Field>
          ...
          <select
            ...
            onChange={handleCurrencyChange}
          >
            <option value="commaDot">1,999.00 ({t('settings:fields:currency:commaDot')})</option>
            <option value="dotComma">1.999,00 ({t('settings:fields:currency:dotComma')})</option>
            <option value="spaceDot">1 999.00 ({t('settings:fields:currency:spaceDot')})</option>
            <option value="spaceComma">1 999,00 ({t('settings:fields:currency:spaceComma')})</option>
          </select>
        </Field>
      </Row>
      <Row>
